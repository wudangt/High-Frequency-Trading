...
from hftbot.models.db_migration.base_transformation import DatabaseTransformation
from hftbot.models.sql_connection_manager import SQLConnectionManager, SQLConnectionType


class Migrator:
    @classmethod
    def _get_transformations(cls):
        import hftbot.models.db_migration.transformations as transformations
