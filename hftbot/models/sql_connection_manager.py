...
from hftbot import data_path
from hftbot.client.config.global_config_map import global_config_map
from hftbot.logger.logger import HftbotLogger
from hftbot.models import get_declarative_base
from hftbot.models.metadata import Metadata as LocalMetadata
...
class SQLConnectionManager:
    ...
    def create_db_path(cls, db_path: Optional[str] = None, db_name: Optional[str] = None) -> str:
        ...
        if db_name is not None:
            ...
            return join(data_path(), "hftbot_trades.sqlite")
    ...
    def __init__(self,
        ...
        if connection_type is SQLConnectionType.TRADE_FILLS:
            ...
            # See: `hftbot/market/markets_recorder.py`, at line 213.
    ...
    def check_and_migrate_db(self):
        from hftbot.model.db_migration.migrator import Migrator
